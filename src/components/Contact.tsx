          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-linear-to-r from-cyan-50 to-blue-50 rounded-2xl p-6 border-l-4 border-cyan-500">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">
                  Fast Response. Real Attention.
                </h4>
                <p className="text-gray-700 text-sm leading-relaxed">
                  Every message gets my personal review — no bots, no delays. You’ll hear back within 24
                  hours, guaranteed.
                </p>
                <p className="text-gray-700 text-sm leading-relaxed">
                  For urgent needs, book a direct call and get immediate expert support.
                </p>
              </div>
            </div>
          </div>
